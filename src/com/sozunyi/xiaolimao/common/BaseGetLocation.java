package com.sozunyi.xiaolimao.common;
 ...
 *
 */
public class BaseGetLocation extends BaseActivity {
	
	/**
	 * 获取定位数据
	 */
	public static String gettedLocation = "定位失败";
	...
	public void startGetLocation(){
		...
		try{
			System.out.println(LocationApplication.locationService.toString());
			// -----------location config ------------
		...
		{
			gettedLocation = "定位失败";
			Toast.makeText(this, "请开启网络或者GPS", Toast.LENGTH_LONG).show();
		}
	}
