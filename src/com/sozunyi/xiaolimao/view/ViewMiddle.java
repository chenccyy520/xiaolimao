...
public class ViewMiddle extends LinearLayout implements ViewBaseAction {
	...
	private MyArrayAdapter plateListViewAdapter;
	private MyArrayAdapter earaListViewAdapter;
	...
	private void init(Context context) {
		...
		earaListViewAdapter = new MyArrayAdapter(context, groups,
		...
		earaListViewAdapter
				.setOnItemClickListener(new MyArrayAdapter.OnItemClickListener() {
		...
		plateListViewAdapter = new MyArrayAdapter(context, childrenItem,
